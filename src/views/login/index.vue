<template>
  <div class="lowin  lowin-blue">
        ...
        <div class="lowin-box-inner">
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules">
            ...
            <div class="lowin-group">
              <label>昵称 </label>
              <el-input ref="userName" v-model="loginForm.userName" class="lowin-input" placeholder="昵称" name="userName" type="text" tabindex="1" auto-complete="on"/>
            </div>
    ...
    <div class="account-foot-copyright">
      <span>Copyright ©2024- 萌萌哒晓菲菲 版权所有</span>
    </div>
  </div>
</template>
